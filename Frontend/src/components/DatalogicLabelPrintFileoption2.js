  ...
  return (
    <div className="datalogiclabeloption2-container" ref={ref}>
        <table className="datalogiclabeltableoption2">
          ...
          {/* <tr>
            <th colspan="3" className="datalogiclabeltableoption2-th"><span style={{marginLeft:"-60px"}}>CCL DESIGN VINA Co., Ltd</span><img src="/img/logoccl.png" style={{width:"85px",height:"28px",position:"absolute",top:"0",marginLeft:"8px"}}></img> </th>
          </tr>
          <tr>
            <td className="datalogiclabeltableoption2-td-above">
              <a className="datalogiclabeltableoption2-circle">1</a>
          ...
          <td className="datalogiclabeltableoption2-td-above">
            ...
            <td className="datalogiclabeltableoption2-td-below" style={props.iteminfo.partname.length>35 ? {fontSize:"14px"} : (props.iteminfo.partname.length>25 ? {fontSize:"16px"} :{fontSize:"18px"})}>{props.iteminfo.partname}</td>
          </tr>
          <tr>
          <td className="datalogiclabeltableoption2-td-above">
              <a className="datalogiclabeltableoption2-circle">3</a>
            ...
            <td className="datalogiclabeltableoption2-td-below"><Barcode value={props.iteminfo.partnumber} height={35} margin={1} fontSize={20}/></td>
          </tr>
          <tr>
          <td className="datalogiclabeltableoption2-td-above">
              <a className="datalogiclabeltableoption2-circle">4</a>
          ...
          <td className="datalogiclabeltableoption2-td-above">
            ...
            <td className="datalogiclabeltableoption2-td-below" style={props.iteminfo.color.length>20 ? {fontSize:"13px",fontWeight:"700"} : {fontSize:"18px",fontWeight:"700"}}>{props.iteminfo.color}</td>
          </tr>
          <tr>
          <td className="datalogiclabeltableoption2-td-above">
              <a className="datalogiclabeltableoption2-circle">6</a>
            ...
            <td className="datalogiclabeltableoption2-td-below"><Barcode value={props.quantity} height={28} margin={1} fontSize={20}/></td>
          </tr>
          <tr>
          <td className="datalogiclabeltableoption2-td-above">
              <a className="datalogiclabeltableoption2-circle">7</a>
              <label className="datalogiclabeltableoption2-label" style={{fontSize:"17px"}}>MANUFACTURING DATE</label>
            </td>
            <td className="datalogiclabeltableoption2-td-below">{convertCreatedAt(Date.now())}</td>
          </tr>
          <tr>
          ...
          <tr>
            <td className="datalogiclabeltableoption2-td-above">
              <a className="datalogiclabeltableoption2-circle">9</a>
              <label className="datalogiclabeltableoption2-label" style={{fontSize:"15px"}}>MATERIAL MANUFACTURER</label>
            </td>
            <td className="datalogiclabeltableoption2-td-below">{props.iteminfo.materialmanufactuer}</td>
          </tr>
          <tr>
            ...
            <td className="datalogiclabeltableoption2-td-below" style={props.iteminfo.materialtype.length>35 ? {fontSize:"14px"} : (props.iteminfo.materialtype.length>25 ? {fontSize:"16px"} :{fontSize:"18px"})}>{props.iteminfo.materialtype}</td>
          </tr>
          <tr>
            <td className="datalogiclabeltableoption2-td-above">
              <a className="datalogiclabeltableoption2-circle">11</a>
          ...
          <tr>
            <td className="datalogiclabeltableoption2-td-above">
              <a className="datalogiclabeltableoption2-circle">12</a>
              <label className="datalogiclabeltableoption2-label">COUNTRY OF ORIGIN</label>
            </td>
            <td className="datalogiclabeltableoption2-td-below">{props.iteminfo.countryorigon.toLowerCase().includes("vietnam") ? "VIET NAM" : "CHINA"}</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td className="datalogiclabeltableoption2-td-below" style={props.iteminfo.ulfile.length>70 ? {fontSize:"13px"} : (props.iteminfo.ulfile.length>35 ? {fontSize:"15px"} : (props.iteminfo.ulfile.length>25 ? {fontSize:"16px"} :{fontSize:"18px"}))}>{props.iteminfo.ulfile}</td>
          </tr> */}
        </table>  
