...
import { FETCH_LEAVEREQUEST_SUCCESS, ADD_NEW_LEAVEREQUEST_SUCCESS, UPDATE_LEAVEREQUEST_SUCCESS, FETCH_EMPCODE_SUCCESS, UPLOADDATALOGICBOXLABEL_SUCCESS, FETCH_DATALOGICBOXLABEL_SUCCESS, FETCH_JABILBOXLABEL_SUCCESS } from "./action";
const initialState = {
  ...
  empcodelist:null,
  // used for quality-datalogic box label
  datalogicboxlabel: null,
  // used for quality-datalogic box label
  jabilboxlabel: null
};
...
const rootReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case UPLOADDATALOGICBOXLABEL_SUCCESS:
      return {
        ...state,
        datalogicboxlabel: action.payload,
      };

    case FETCH_DATALOGICBOXLABEL_SUCCESS:
    return {
      ...state,
      datalogicboxlabel: action.payload,
    };

    case FETCH_JABILBOXLABEL_SUCCESS:
      return {
        ...state,
        jabilboxlabel: action.payload,
      };
