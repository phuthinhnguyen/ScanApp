...
import { FETCH_LEAVEREQUEST_SUCCESS, ADD_NEW_LEAVEREQUEST_SUCCESS, UPDATE_LEAVEREQUEST_SUCCESS, FETCH_EMPCODE_SUCCESS, UPLOADDATALOGICBOXLABEL_SUCCESS, FETCH_DATALOGICBOXLABEL_SUCCESS } from "./action";
const initialState = {
